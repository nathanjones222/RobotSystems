...
class Picarx(object):
    ...
    def backward(self, speed):
        ...
        # implement Ackerman approximation
        steering_angle_radians = math.radians(current_angle)
        power_scale = math.cos(steering_angle_radians)
    ...
    def k_turning(self, speed = 30, left_steering_time_1 = 2.5, right_steering_time = 2.5, left_steering_time_2 = 3.5, forward_steering_time = 1.0):
